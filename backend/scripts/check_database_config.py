...
from app.database import get_database_info, get_test_database_path, is_test_environment, DATABASE_PATH
...
def main():
    ...
    print(f"🔍 Current Environment Detection:")
    ...
    print(f"   Directory Writable: {os.access(os.path.dirname(db_path), os.W_OK) if db_path else 'N/A'}")
    ...
    try:
        ...
        if is_test_environment():
            ...
            print(f"✅ Test database reset successful")
