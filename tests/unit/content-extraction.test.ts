    ...
    it('should strip HTML tags from htmlContent', () => {
      const content: MockContent = {
        ...
        items: [
          {
            type: 'post',
            htmlContent: '<p>This is <strong>bold</strong> text with <a href="link">links</a></p>'
          }
        ]
      };
      const result = convertContentToText(content);
      expect(result).toBe('HTML Discussion\n\n[POST] This is bold text with links');
    });
    ...
    it('should handle real-world Reddit-like content structure', () => {
      const redditLikeContent: MockContent = {
        ...
        items: [
          {
            type: 'post',
            htmlContent: '<div class="usertext-body"><div class="md"><p>I just learned that async/await in JavaScript is syntactic sugar over Promises. This makes asynchronous code much more readable than callback hell.</p></div></div>'
          },
          {
            type: 'comment',
            textContent: 'Great explanation! I wish I had learned this earlier in my career.'
          },
          {
            type: 'comment',
            htmlContent: '<div class="usertext-body"><div class="md"><p>Here\'s a great resource: <a href="https://example.com">MDN Async/Await Guide</a></p></div></div>'
          }
        ]
      };
      ...
      expect(result).toContain('[COMMENT] Here\'s a great resource: MDN Async/Await Guide');
    ...
    it('should handle HackerNews-like content structure', () => {
      const hackerNewsLikeContent: MockContent = {
        ...
        items: [
          {
            type: 'post',
            textContent: 'After struggling with existing tools, I built my own productivity app. It uses the Pomodoro technique with customizable intervals.'
          },
          {
            type: 'comment',
            textContent: 'Nice work! How does this compare to existing Pomodoro apps like Forest or Be Focused?'
          },
          {
            type: 'comment',
            textContent: 'The key differentiator is the adaptive intervals based on your focus patterns. Traditional Pomodoro is too rigid for deep work.'
          }
        ]
      };
      ...
      expect(result).toContain('[COMMENT] The key differentiator is the adaptive');
    });
  });
});