...
describe('SecurityManager', () => {
  ...
  describe('Storage Integrity', () => {
    it('should verify valid storage integrity', async () => {
      ...
      const result = await securityManager.verifyStorageIntegrity(validEncryptedData);
      expect(result).toBe(true);
    });
    ...
    it('should reject missing encrypted data', async () => {
      ...
      const result = await securityManager.verifyStorageIntegrity(invalidEncryptedData);
      expect(result).toBe(false);
    });
