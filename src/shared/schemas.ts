			...
			items: {
				...
				properties: {
					...
					startContent: {
						type: "string",
						description:
							"The first (max 5) words of the golden nugget verbatim, without any changes to wording/symbols/casing.",
					},
					endContent: {
						type: "string",
						description:
							"The last (max 5) words of the golden nugget verbatim, without any changes to wording/symbols/casing.",
					},
					synthesis: {
						type: "string",
						description:
