...
describe('NotificationManager', () => {
  ...
  describe('showError', () => {
    ...
    it('should auto-hide after timeout', () => {
      ...
      expect(document.querySelector('.nugget-notification-banner')).toBeTruthy();
    ...
    it('should clear previous timeout when showing new error', () => {
      ...
      expect(document.querySelector('.nugget-notification-banner')).toBeTruthy();
      expect(document.querySelector('.nugget-notification-banner')?.textContent).toBe('Second error');
    });
  });
  ...
  describe('banner styling', () => {
    it('should apply correct styles for progress banner', () => {
      ...
      const banner = document.querySelector('.nugget-notification-banner') as HTMLElement;
