...
import { ChromeExtensionHealth } from "../components/chrome/ChromeExtensionHealth";
import { ChromePromptManager } from "../components/chrome/ChromePromptManager";
import { OptimizationMappingTable } from "../components/chrome/OptimizationMappingTable";
		...
		<ResponsiveContainer maxWidth="full" className="min-h-screen">
			...
			>
				<TabsList className="grid h-auto w-full grid-cols-3 sm:grid-cols-6">
					...
					<TabsTrigger value="chrome" className="px-2 py-2 text-xs sm:text-sm">
